    ...
    <div className="max-w-6xl mx-auto space-y-8">
      ...
      <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-200 text-center">
        ...
        <p className="text-slate-500 mb-8 text-lg">
          Kargonuzun nerede olduğunu ve teslimat rotasını anlık takip edin.
        </p>
        ...
        {error && (
          <p className="mt-4 text-red-500 font-bold animate-pulse">{error}</p>
        )}
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 animate-fade-in">
                ...
                <div className="flex gap-8">
                  <div>
                    ...
                    <span className="text-lg font-bold text-blue-600">
                      {data.cargo.weight.toFixed(1)} kg
                    </span>
                  </div>
                  <div>
                    <span className="text-sm text-slate-500 block">Durum</span>
                    <span className="bg-green-100 text-green-700 px-2 py-0.5 rounded text-xs font-black tracking-tighter uppercase">
                      TAŞIMA SÜRECİNDE
                    </span>
                  </div>
                </div>
                    ...
                    <div key={idx} className="flex items-center gap-3">
                      ...
                      <span
                        className={`text-sm font-medium ${
                          stop.name === data.cargo.station_name
          ...
          <div className="lg:col-span-8 bg-white p-2 rounded-2xl shadow-sm border border-slate-200 h-[500px]">
            ...
            >
              ...
              <Polyline
                positions={data.route?.realPath || data.route?.path || []}
